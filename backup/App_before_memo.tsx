...
// Les boîtes de dialogue seront désormais chargées paresseusement (lazy loading)
...
// ---- Déclarations des composants chargés paresseusement ----
const EmailDialog = lazy(() => import('./components/Dialogs').then(m => ({ default: m.EmailDialog })));
const RappelDialog = lazy(() => import('./components/Dialogs').then(m => ({ default: m.RappelDialog })));
const RendezVousDialog = lazy(() => import('./components/Dialogs').then(m => ({ default: m.RendezVousDialog })));
const QualificationDialog = lazy(() => import('./components/Dialogs').then(m => ({ default: m.QualificationDialog })));
const GenericInfoDialog = lazy(() => import('./components/Dialogs').then(m => ({ default: m.GenericInfoDialog })));

const ShortcutConfigDialog = lazy(() => import('./components/ShortcutConfigDialog').then(m => ({ default: m.ShortcutConfigDialog })));
